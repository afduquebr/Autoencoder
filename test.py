...
axes.set_xlabel('Signal Acceptance')
axes.set_ylabel('Backgroung Acceptance')
...
axes.hist([mjj_sample[:100000][loss_sample_total > threshold[96 - 1]]], nbins, range=(2700, 5000), density=1, histtype='step', label=['96%'], stacked=True, alpha=1)
